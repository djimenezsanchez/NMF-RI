function [] = displayResult(AnmfRI,Anmf_withoutAF,Anmf_withstraightAF,ControlSpectraAll,A0)
...
hold on; plot(zeros(1,9),'LineStyle','--','LineWidth',1,'Color',[0,0,0]);

hold on; plot(AnmfRI(1:9,1),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,0,1]);
hold on; plot(AnmfRI(1:9,2),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,1,0]);
hold on; plot(AnmfRI(1:9,3),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[.9,.9,0]);
hold on; plot(AnmfRI(1:9,4),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[1,0,0]);
hold on; plot(AnmfRI(1:9,5),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[1,0,1]);
hold on; plot(AnmfRI(1:9,6),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[.5,.5,.5]);
hold on; plot(AnmfRI(1:9,7),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,1,1]);
hold on; plot(AnmfRI(1:9,8),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,0,0]);
...
hold on; plot(zeros(9,1),'LineStyle','--','LineWidth',1,'Color',[0,0,0]);

hold on; plot(AnmfRI(10:18,1),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,0,1]);
hold on; plot(AnmfRI(10:18,2),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,1,0]);
hold on; plot(AnmfRI(10:18,3),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[.9,.9,0]);
hold on; plot(AnmfRI(10:18,4),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[1,0,0]);
hold on; plot(AnmfRI(10:18,5),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[1,0,1]);
hold on; plot(AnmfRI(10:18,6),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[.5,.5,.5]);
hold on; plot(AnmfRI(10:18,7),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,1,1]);
hold on; plot(AnmfRI(10:18,8),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,0,0]);
...
hold on; plot(zeros(1,8),'LineStyle','--','LineWidth',1,'Color',[0,0,0]);

hold on; plot(AnmfRI(19:26,1),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,0,1]);
hold on; plot(AnmfRI(19:26,2),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,1,0]);
hold on; plot(AnmfRI(19:26,3),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[.9,.9,0]);
hold on; plot(AnmfRI(19:26,4),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[1,0,0]);
hold on; plot(AnmfRI(19:26,5),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[1,0,1]);
hold on; plot(AnmfRI(19:26,6),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[.5,.5,.5]);
hold on; plot(AnmfRI(19:26,7),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,1,1]);
hold on; plot(AnmfRI(19:26,8),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,0,0]);

hold on; plot(Anmf_withoutAF(19:26,1),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[0,0,1]);
hold on; plot(Anmf_withoutAF(19:26,2),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[0,1,0]);
hold on; plot(Anmf_withoutAF(19:26,3),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[.9,.9,0]);
hold on; plot(Anmf_withoutAF(19:26,4),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[1,0,0]);
hold on; plot(Anmf_withoutAF(19:26,5),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[1,0,1]);
hold on; plot(Anmf_withoutAF(19:26,6),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[.5,.5,.5]);
hold on; plot(Anmf_withoutAF(19:26,7),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[0,1,1]);
hold on; plot(zeros(8,1),'LineStyle','-','Marker','*','LineWidth',1,'Color',[0,0,0]);

hold on; plot(Anmf_withstraightAF(19:26,1),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[0,0,1]);
hold on; plot(Anmf_withstraightAF(19:26,2),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[0,1,0]);
hold on; plot(Anmf_withstraightAF(19:26,3),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[.9,.9,0]);
hold on; plot(Anmf_withstraightAF(19:26,4),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[1,0,0]);
hold on; plot(Anmf_withstraightAF(19:26,5),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[1,0,1]);
hold on; plot(Anmf_withstraightAF(19:26,6),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[.5,.5,.5]);
hold on; plot(Anmf_withstraightAF(19:26,7),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[0,1,1]);
hold on; plot(zeros(8,1),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[0,0,0]);
...
hold on; plot(zeros(1,6),'LineStyle','--','LineWidth',1,'Color',[0,0,0]);

hold on; plot(AnmfRI(27:32,1),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,0,1]);
hold on; plot(AnmfRI(27:32,2),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,1,0]);
hold on; plot(AnmfRI(27:32,3),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[.9,.9,0]);
hold on; plot(AnmfRI(27:32,4),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[1,0,0]);
hold on; plot(AnmfRI(27:32,5),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[1,0,1]);
hold on; plot(AnmfRI(27:32,6),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[.5,.5,.5]);
hold on; plot(AnmfRI(27:32,7),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,1,1]);
hold on; plot(AnmfRI(27:32,8),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,0,0]);

hold on; plot(Anmf_withoutAF(27:32,1),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[0,0,1]);
hold on; plot(Anmf_withoutAF(27:32,2),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[0,1,0]);
hold on; plot(Anmf_withoutAF(27:32,3),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[.9,.9,0]);
hold on; plot(Anmf_withoutAF(27:32,4),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[1,0,0]);
hold on; plot(Anmf_withoutAF(27:32,5),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[1,0,1]);
hold on; plot(Anmf_withoutAF(27:32,6),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[.5,.5,.5]);
hold on; plot(Anmf_withoutAF(27:32,7),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[0,1,1]);
hold on; plot(zeros(6,1),'LineStyle','-','Marker','*','LineWidth',1,'Color',[0,0,0]);

hold on; plot(Anmf_withstraightAF(27:32,1),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[0,0,1]);
hold on; plot(Anmf_withstraightAF(27:32,2),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[0,1,0]);
hold on; plot(Anmf_withstraightAF(27:32,3),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[.9,.9,0]);
hold on; plot(Anmf_withstraightAF(27:32,4),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[1,0,0]);
hold on; plot(Anmf_withstraightAF(27:32,5),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[1,0,1]);
hold on; plot(Anmf_withstraightAF(27:32,6),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[.5,.5,.5]);
hold on; plot(Anmf_withstraightAF(27:32,7),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[0,1,1]);
hold on; plot(zeros(6,1),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[0,0,0]);
...
hold on; plot(zeros(1,3),'LineStyle','--','LineWidth',1,'Color',[0,0,0]);

hold on; plot(AnmfRI(33:end,1),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,0,1]);
hold on; plot(AnmfRI(33:end,2),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,1,0]);
hold on; plot(AnmfRI(33:end,3),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[.9,.9,0]);
hold on; plot(AnmfRI(33:end,4),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[1,0,0]);
hold on; plot(AnmfRI(33:end,5),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[1,0,1]);
hold on; plot(AnmfRI(33:end,6),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[.5,.5,.5]);
hold on; plot(AnmfRI(33:end,7),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,1,1]);
hold on; plot(AnmfRI(33:end,8),'LineStyle','-','Marker','o','MarkerSize',9,'LineWidth',1,'Color',[0,0,0]);

hold on; plot(Anmf_withoutAF(33:end,1),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[0,0,1]);
hold on; plot(Anmf_withoutAF(33:end,2),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[0,1,0]);
hold on; plot(Anmf_withoutAF(33:end,3),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[.9,.9,0]);
hold on; plot(Anmf_withoutAF(33:end,4),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[1,0,0]);
hold on; plot(Anmf_withoutAF(33:end,5),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[1,0,1]);
hold on; plot(Anmf_withoutAF(33:end,6),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[.5,.5,.5]);
hold on; plot(Anmf_withoutAF(33:end,7),'LineStyle','-','Marker','*','MarkerSize',9,'LineWidth',1,'Color',[0,1,1]);
hold on; plot(zeros(3,1),'LineStyle','-','Marker','*','LineWidth',1,'Color',[0,0,0]);

hold on; plot(Anmf_withstraightAF(33:end,1),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[0,0,1]);
hold on; plot(Anmf_withstraightAF(33:end,2),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[0,1,0]);
hold on; plot(Anmf_withstraightAF(33:end,3),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[.9,.9,0]);
hold on; plot(Anmf_withstraightAF(33:end,4),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[1,0,0]);
hold on; plot(Anmf_withstraightAF(33:end,5),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[1,0,1]);
hold on; plot(Anmf_withstraightAF(33:end,6),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[.5,.5,.5]);
hold on; plot(Anmf_withstraightAF(33:end,7),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[0,1,1]);
hold on; plot(zeros(3,1),'LineStyle','-','Marker','+','MarkerSize',9,'LineWidth',1,'Color',[0,0,0]);
